...
<%  
	...
	if( (type_prod != null || type_prod.trim().equals("")) && model_prod == null ){ 
		...
		{  
			...
			Connection con = DriverManager.getConnection("jdbc:mysql://root:root@localhost:3306/powerfulrig?autoReconnect=true&useSSL=false&useUnicode=true&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC");  
