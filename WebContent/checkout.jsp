				...
				<div class="row spacerInfo2">
					<div class="col-xl-6 setupAddress">
						...
						<% ArrayList<String> addresses = new ArrayList<>();
							addresses.add(utenteLoggato.getUser_first_address());
							addresses.add(utenteLoggato.getUser_second_address());
							addresses.add(utenteLoggato.getUser_third_address());
					...
					<div class="col-xl-6 spacerMethod_payment">
						...
						<% 
						isStampato = false;
						ArrayList<PaymentMethodBean> paymentMethods = model_payment.doRetrieveByUsername(utenteLoggato.getUsername());
